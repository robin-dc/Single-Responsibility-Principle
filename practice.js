...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  bakePies(pieQuantity, recipe, pieType, profitMargin)
}

function bakePies(pieQuantity, recipe, pieType, profitMargin){
  // Bake the number of pies specified by the pieQuantity
  for (let i = 0; i < pieQuantity; i++) {
    printIngredients(recipe, pieType, i, profitMargin)
  }
  costEach(recipe, pieQuantity, profitMargin)
}

function printIngredients(recipe, pieType, i, profitMargin){
